                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="tp-header-top-address tp-header-5-top-address">
                            ...
                            <span><i class="fa-thin fa-location-dot"></i><a href="<?php echo $address_text; ?>"> <?php echo $address_text; ?></a></span>
                            <?php endif; ?>
                            
                            <?php if(!empty($email_address)):?>
                            <span><i class="fa-light fa-envelope"></i> <a href="mailto:techubinfo@mail.com"><?php echo $email_address; ?></a></span>
                            <?php endif; ?>
