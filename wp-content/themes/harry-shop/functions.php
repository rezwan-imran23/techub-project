...
function harry_widgets_init() {
	...
	register_sidebar( array(
		...
		'id'            => 'blog-sidebar',
		'description'   => __( 'Widgets in this area will be shown on blog sidebar.', 'harry' ),
	...
	register_sidebar( array(
		...
		'id'            => 'footer-widget-1',
		'description'   => __( 'Widgets in this area will be shown on footer widget 01 column.', 'harry' ),
...
if ( class_exists( 'WooCommerce' ) ) {
	include_once('inc/harry-woo.php');
}
