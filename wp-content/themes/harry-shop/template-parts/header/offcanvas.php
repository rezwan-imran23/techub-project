...
$header_side_logo = get_theme_mod('header_side_logo',get_template_directory_uri().'/assets/img/logo/logo-green.svg');
$header_side_content = get_theme_mod('header_side_content',__('lorem20','techub'));
...
$header_side_phone = get_theme_mod('header_side_phone',__('01776706540','techub'));
