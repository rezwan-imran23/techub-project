	...
	protected function  register_controls_section(){
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'Author Name', 'textdomain' ),
				'placeholder' => esc_html__( 'Author Name', 'textdomain' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'Author Designation Here', 'textdomain' ),
		...
		$this->add_control(
			'techub_sig_image',
			[
				'label' => esc_html__( 'Your Signature', 'textdomain' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'default' => [
					'url' => \Elementor\Utils::get_placeholder_image_src(),
				],
                    ...
                    <div class="col-xl-6 col-lg-7">
                        <div class="tp-about-wrapper mt-25 ml-20 wow fadeInRight">
                            <div class="tp-section-title-wrapper mb-40">
                                ...
                                <h3 class="tp-section-5-title"><?php echo techub_kses($settings['techub_title']);?></h3>
                                ...
                                <div class="tp-about-feature-item d-flex <?php echo esc_attr($key_class);?>">
                                    <div class="tp-about-feature-icon">
                                        <span>
											...
											<?php elseif ($item ['icon_select']=='svg') :?>
