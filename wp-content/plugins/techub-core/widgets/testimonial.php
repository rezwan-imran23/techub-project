	...
	protected function  register_controls_section(){
		...
		$repeater->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'CEO of Wizlie', 'textdomain' ),
				'placeholder' => esc_html__( 'Type your title here', 'textdomain' ),
			]
		);
...
<div class="tp-testimonial-insu-tab-wrapper mt-20">
                            <div class="row">
                                            ...
                                            <div class="tab-pane fade <?php echo esc_attr($show); ?>" id="v-pills-man1-<?php echo esc_attr($key);?>" role="tabpanel" aria-labelledby="v-pills-man1-tab-<?php echo esc_attr($key);?>">
                                                <div class="tp-client-review p-relative">
                                                    <div class="tp-client-caption">
                                                        <img src="<?php get_template_directory_uri();?>/assets/img/testimonial/testi-star.png" alt="">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
									...
									<?php foreach( $settings['item_list'] as $key => $item):	
											$active = $key == 0 ? 'active' : 'collapsed';?>

                                        <button class="tp-testimonial-btn tp-testimonial-item d-flex nav-link <?php echo esc_attr($active); ?> " 
												id="v-pills-man1-tab-<?php echo esc_attr($key);?>" 
												data-bs-toggle="pill" 
												data-bs-target="#v-pills-man1-<?php echo esc_attr($key);?>" 
												type="button" 
												role="tab" 
												aria-controls="v-pills-man1-<?php echo esc_attr($key);?>" 
												aria-selected="true">
                                            <span class="tp-testimonial-tab-btn">
                                                <img src="<?php echo esc_url($item['techub_image']['url']) ?>">
                                            </span>
                                        </button>
