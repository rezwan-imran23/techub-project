...
class Techub_Hero extends Widget_Base {
   ...
   //style tabs control section
	...
	protected function render() {
		...
		//Button2
		if ( !empty( $settings['button_2_link']) ) {
		...
		<!-- <a <?php echo $this->get_render_attribute_string( 'button_arg' ); ?>><span>Get Started</span></a> -->
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="tp-slider-5-content p-relative z-index-11">
								...
								<?php endif;?>
                                    ...
                                    <a <?php echo $this->get_render_attribute_string( 'button_2_arg' ); ?>><span><?php echo esc_html($settings['button_2_text'])?></span></span></a>
