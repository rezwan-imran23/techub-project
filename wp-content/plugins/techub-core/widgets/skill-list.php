						...
						<?php foreach( $settings['item_list'] as $item ) : ?>
                                ...
                                <div class="tp-skill fix pb-20">
                                    ...
                                    <div class="progress progress-2">
                                        <div class="progress-bar progress-bar-2 wow slideInLeft" 
										data-wow-duration="1s" data-wow-delay=".8s" role="progressbar" 
										aria-label="Example with label" 
										style="width: <?php echo esc_html($item['techub_number']); ?>%;" 
										aria-valuenow="<?php echo esc_html($item['techub_number']); ?>" 
										aria-valuemin="0" aria-valuemax="100">
										<span class="progresscounter"><?php echo esc_html($item['techub_number']); ?>%</span>
									    </div>
                                    </div>
                                </div>
