   ...
   <section class="tp-service-5-area p-relative fix">
            <div class="container">
				...
				<?php foreach( $settings['item_list'] as $item):?>
                    ...
                    <div class="col-xl-<?php echo esc_attr( $settings['xl_column']);?> col-lg-col-xl-<?php echo esc_attr( $settings['lg_column']);?>">

                        <div class=" tp-service-5-wrapper elementor-repeater-item-<?php echo esc_attr( $item['_id'] );?>
						mb-30 wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
